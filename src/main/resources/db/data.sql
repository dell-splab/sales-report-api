...
insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(1, 'Sara Morse', 'morse_s@gmail.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(2, 'Karen Parker', 'parker_k@icloud.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(3, 'Skyler White', 'white.s@gmail.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(4, 'Hector Salamanca', 'salamanca.h@outlook.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(5, 'Martin Underwood', 'underwood_m@outlook.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(6, 'Clifford Main', 'main.c@gmail.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(7, 'Erin Brill', 'brill_e@gmail.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(8, 'Tyrus Kitt', 'kitt_t@gmail.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(9, 'Gary Ramos', 'ramos.g@outlook.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(10, 'Marco Salamanca', 'salamanca.m@gmail.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(11, 'Steven Gomez', 'gomez_s@icloud.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(12, 'Mark Vega', 'vega_m@gmail.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(13, 'Karen Arnold', 'arnold.k@gmail.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(14, 'Tracey Stokes', 'stokes_t@outlook.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(15, 'Howard Hamlin', 'hamlin.h@outlook.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(16, 'Tuco Salamanca', 'salamanca.t@outlook.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(17, 'Teresa Barrett DVM', 'dvm.t@icloud.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(18, 'Kimberly Wallace', 'wallace_k@outlook.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(19, 'James Jones', 'jones_j@gmail.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(20, 'Bill Williams', 'williams_b@icloud.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(21, 'Kim Wexler', 'wexler_k@gmail.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(22, 'Daniel Ayala', 'ayala.d@outlook.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(23, 'Sobchak', 'sobchak.s@gmail.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(24, 'Kelly Mendoza', 'mendoza_k@icloud.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(25, 'Dr. Cruz', 'cruz.d@icloud.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(26, 'Gale Boetticher', 'boetticher.g@gmail.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(27, 'Lydia Rodarte-Quayle', 'rodarte-quayle_l@icloud.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(28, 'Leonel Salamanca', 'salamanca.l@gmail.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(29, 'Viola Goto', 'goto_v@icloud.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(30, 'Sarah Dickerson', 'dickerson_s@gmail.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(31, 'Aimee Mccarthy', 'mccarthy_a@gmail.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(32, 'Kathleen Stevens', 'stevens.k@icloud.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(33, 'Richard Costa', 'costa_r@outlook.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(34, 'Walter White Jr.', 'jr._w@outlook.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(35, 'Alison Turner', 'turner.a@gmail.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(36, 'Craig Kettleman', 'kettleman_c@outlook.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(37, 'Elizabeth Bush', 'bush.e@icloud.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(38, 'Dr. Caldera', 'caldera_d@gmail.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(39, 'David Collins', 'collins_d@gmail.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(40, 'Kaylee Ehrmantraut', 'ehrmantraut.k@gmail.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(41, 'Roberto Johnson', 'johnson.r@gmail.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(42, 'Rich Schweikart', 'schweikart.r@gmail.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(43, 'Jane Margolis', 'margolis.j@outlook.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(44, 'Werner Ziegler', 'ziegler.w@gmail.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(45, 'Maureen Bruckner', 'bruckner_m@icloud.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(46, 'Linda Harvey', 'harvey.l@outlook.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(47, 'Sandra Payne', 'payne.s@outlook.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(48, 'Don Eladio Vuente', 'vuente.d@gmail.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(49, 'Megan Myers', 'myers_m@outlook.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(50, 'Hank Schrader', 'schrader.h@icloud.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(51, 'Marie Schrader', 'schrader_m@gmail.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(52, 'Gustago Fring', 'fring.g@icloud.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(53, 'Mary Lyons', 'lyons.m@gmail.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(54, 'Rachel Martin', 'martin_r@icloud.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(55, 'Kelly Mcclain', 'mcclain.k@gmail.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(56, 'Scott Leblanc', 'leblanc_s@icloud.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(57, 'Rebecca Woods', 'woods.r@icloud.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(58, 'Alicia Richardson', 'richardson_a@outlook.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(59, 'Stacey Ehrmantraut', 'ehrmantraut_s@icloud.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(60, 'Elliott Schwartz', 'schwartz_e@outlook.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(61, 'Robert Baxter', 'baxter.r@icloud.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(62, 'Curtis Mcconnell', 'mcconnell_c@icloud.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(63, 'Saul Goodman', 'goodman_s@gmail.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(64, 'Angela Bennett', 'bennett.a@outlook.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(65, 'Tara Maldonado', 'maldonado_t@gmail.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(66, 'Mr. Brian Roman', 'roman_m@gmail.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(67, 'Lyle', 'lyle_l@icloud.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(68, 'Todd Alquist', 'alquist.t@outlook.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(69, 'Chuck McGill', 'mcgill.c@outlook.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(70, 'Patrick Gutierrez', 'gutierrez_p@outlook.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(71, 'Walter White', 'white_w@gmail.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(72, 'Jesse Pinkman', 'pinkman.j@icloud.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(73, 'Billy Miller', 'miller.b@icloud.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(74, 'Anthony Aguirre', 'aguirre.a@gmail.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(75, 'Francesca Liddy', 'liddy_f@outlook.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(76, 'Zachary Baker', 'baker_z@icloud.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(77, 'Deborah Wright', 'wright_d@icloud.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(78, 'Kevin Wachtell', 'wachtell.k@icloud.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(79, 'Huell Babineaux', 'babineaux.h@gmail.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(80, 'Daniel Wilson', 'wilson.d@gmail.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(81, 'Jimmy McGill', 'mcgill.j@icloud.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(82, 'Lado Salamanca', 'salamanca.l@outlook.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(83, 'Heather Moore', 'moore.h@outlook.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(84, 'John Hendricks', 'hendricks_j@icloud.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(85, 'Mary Church', 'church_m@gmail.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(86, 'Patrick Daniel', 'daniel_p@gmail.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(87, 'Nacho Varga', 'varga.n@outlook.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(88, 'Kevin Evans', 'evans.k@icloud.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(89, 'Yvette Jones', 'jones.y@gmail.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(90, 'Toni Rice DDS', 'dds.t@outlook.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(91, 'Tyler Henderson DDS', 'dds_t@gmail.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(92, 'Ted Beneke', 'beneke_t@outlook.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(93, 'Omar', 'omar_o@outlook.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(94, 'Betsy Kettleman', 'kettleman_b@icloud.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(95, 'Leah Hayden', 'hayden_l@icloud.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(96, 'Wanda Harris', 'harris_w@icloud.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(97, 'Jonathan Williams', 'williams_j@gmail.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(98, 'Tyler Kennedy', 'kennedy.t@gmail.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(99, 'Kathy Olson', 'olson_k@gmail.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(100, 'Amy Lopez', 'lopez_a@outlook.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(101, 'Blake Thomas', 'thomas.b@gmail.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(102, 'Angela French', 'french_a@outlook.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(103, 'Lisa Morris PhD', 'phd.l@outlook.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(104, 'Jeffery Shelton', 'shelton_j@outlook.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(105, 'Patrick Roberts', 'roberts.p@outlook.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(106, 'Patrick Stuart', 'stuart_p@gmail.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(107, 'Gretchen Schwartz', 'schwartz_g@gmail.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(108, 'Danielle Medina', 'medina_d@gmail.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(109, 'Manuel Varga', 'varga.m@icloud.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(110, 'Donald Solis', 'solis_d@outlook.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(111, 'Anita', 'anita.a@outlook.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(112, 'Jamie Navarro', 'navarro_j@icloud.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(113, 'Ashley Johnson', 'johnson.a@icloud.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(114, 'Joseph Strickland', 'strickland_j@outlook.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(115, 'Charles Serrano', 'serrano.c@gmail.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(116, 'Lisa Jones', 'jones_l@gmail.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(117, 'Jennifer Johnson', 'johnson.j@gmail.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(118, 'Natalie Griffin', 'griffin.n@icloud.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(119, 'Brent Evans', 'evans.b@outlook.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(120, 'Marco Pasternak', 'pasternak.m@outlook.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(121, 'Robert Smith', 'smith_r@outlook.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(122, 'Sandra Saunders', 'saunders.s@outlook.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(123, 'Scott Fletcher', 'fletcher.s@icloud.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(124, 'Adam Summers', 'summers_a@icloud.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(125, 'Richard Hooper', 'hooper.r@outlook.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(126, 'Rebecca Bois', 'bois_r@gmail.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(127, 'Lori Heath', 'heath.l@outlook.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(128, 'Deborah Marshall', 'marshall_d@outlook.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(129, 'Mike Ehrmantraut', 'ehrmantraut_m@outlook.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(130, 'Theresa Moyer', 'moyer_t@icloud.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(131, 'Paige Novick', 'novick_p@icloud.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(132, 'Joshua Walton', 'walton_j@icloud.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(133, 'Kuby', 'kuby.k@outlook.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(134, 'Edward Zhang', 'zhang_e@icloud.com', 'monitores');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(135, 'Beth Lozano', 'lozano.b@outlook.com', 'notebooks');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(136, 'Isaiah Ramos', 'ramos.i@outlook.com', 'acessorios');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(137, 'Victor', 'victor_v@icloud.com', 'computadores e PCs');

insert into lead (ID, NAME, EMAIL, SALES_PAGE)
values(138, 'Elizabeth Martinez', 'martinez_e@icloud.com', 'monitores');
